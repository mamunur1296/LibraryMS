...
public class BranchSeeder : IDataSeeder
{
    ...
    {
        var mainBranch = new Branch(Guid.Parse("11110000-0000-0000-0000-000000000001"), "Main Library", "123 Central Ave, New York, NY 10001", "555-0101", "main@library.com");
        var downtownBranch = new Branch(Guid.Parse("22220000-0000-0000-0000-000000000002"), "Downtown Branch", "456 Market St, San Francisco, CA 94105", "555-0102", "downtown@library.com");
